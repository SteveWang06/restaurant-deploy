...
export const ApiPahts = {
    getAllFood: '/v1/api/getAllFood',
    userLogin: '/v1/api/userLogin',
    userFetchProfilt: '/v1/api/fetchProfile',
    userRefreshToken: '/v1/api/refreshToken',
    userOrderFood: '/v1/api/createOrder',
    userRegister: '/v1/api/register',
